...
"""
#this program gives you the information about all the different types of particles, interaction types and detection heights present
#only works for files directly generated by GEANT or modified only by master_new.py (i.e. files in which formatting of a line is unchanged)
def scw_ext():
    import os
